...
export default function FreeBanner() {
  return (
    <section id="free" className="mx-auto max-w-6xl px-5 py-20 md:py-28">
      <div className="overflow-hidden rounded-[2.5rem] border border-lime/20 bg-card text-ink shadow-float">
        <div className="grid gap-10 p-8 md:grid-cols-2 md:p-12">
          {/* left pitch */}
          <div className="flex flex-col justify-center">
            <span className="inline-flex w-fit items-center gap-2 rounded-full bg-lime px-4 py-1.5 text-xs font-bold text-panel">
              💚 Notre promesse
            </span>
            ...
            <a
              href="/app"
              className="mt-7 w-fit rounded-full bg-lime px-7 py-3.5 font-semibold text-panel shadow-soft transition-transform hover:-translate-y-0.5"
            >
          ...
          {/* right table */}
          <div className="rounded-3xl bg-cream-deep p-2 text-ink">
